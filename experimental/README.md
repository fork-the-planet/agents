...
- **[workspace-chat](./workspace-chat/)** — AIChatAgent with a persistent virtual filesystem. Demonstrates `agents/experimental/workspace` with file tools (read, write, list, delete, mkdir, bash, glob) and a file browser sidebar.
